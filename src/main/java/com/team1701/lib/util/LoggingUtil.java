...
public class LoggingUtil {
    ...
    public static void recordOutput(String prefix, ArmSetpoint setpoint) {
        var logger = Logger.getInstance();
        logger.recordOutput(prefix + "/Rotation", setpoint.angle.getRadians());
        logger.recordOutput(prefix + "/Extension", setpoint.extension);
    }
