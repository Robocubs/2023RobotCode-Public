...
public class ControllerManager {
    ...
    /* START CONTROLLER BUTTON MAPPINGS */
    ...
    /* END CONTROLLER BUTTON MAPPINGS */

    /* START CONTROLLER AXES MAPPINGS */
    ...
    private ControllerManager() {
        ...
        mDriverJoystick.setXDeadZone(new DeadZone(Constants.kDriverXDeadZone));
        mDriverJoystick.setYDeadZone(new DeadZone(Constants.kDriverYDeadZone));
        mDriverJoystick.setZDeadZone(new DeadZone(Constants.kDriverYDeadZone));
    ...
    public void onButtonPressed(JoystickMapping mapping, Callback handler) {
        getJoystick(mapping.getSlot()).onButtonPressed(mapping.getButton(), handler);
    }

    public void onButtonReleased(JoystickMapping mapping, Callback handler) {
